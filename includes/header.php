...
<head>
    ...
    <script>window.addEventListener('load',function(){var s=document.createElement('script');s.async=true;s.src='https://www.googletagmanager.com/gtag/js?id=G-2S7HH2R99G';document.head.appendChild(s);window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-2S7HH2R99G');});</script>
    ...
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>css/style.css?v=3.3">
